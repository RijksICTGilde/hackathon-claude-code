...
| `claude-sandbox/podman/sample/pom.xml` | minimaal Maven-project |
| `claude-sandbox/podman/sample/src/test/java/poc/SmokeIT.java` | één Testcontainers-test |
| `claude-sandbox/podman/smoke-test.sh` | rootless-podman + Testcontainers smoke |
| `claude-sandbox/podman/README.md` | run-stappen, `ALLOWED_DOMAINS`, fallbacks |
...
**Files:**
- Create: `claude-sandbox/podman/sample/pom.xml`
- Create: `claude-sandbox/podman/sample/src/test/java/poc/SmokeIT.java`
...
```bash
git add claude-sandbox/podman/sample
...
**Files:**
- Create: `claude-sandbox/podman/smoke-test.sh`
...
```bash
chmod +x claude-sandbox/podman/smoke-test.sh
```

- [ ] **Step 3: Check**

Run: `shellcheck claude-sandbox/podman/smoke-test.sh` (indien beschikbaar) → geen errors.
Echt draaien: in de container `./smoke-test.sh` (host-stap).

- [ ] **Step 4: Commit**

```bash
git add claude-sandbox/podman/smoke-test.sh
...
**Files:**
- Create: `claude-sandbox/podman/README.md`
...
```bash
git add claude-sandbox/podman/README.md
